...
|-------------|----------------|----------|---------------|
| [🏨 Booking Hotel](https://github.com/PhongNguyen-1992/Aribnb_CSE/tree/main/AribnbCapstore) | A full-featured **hotel booking platform** inspired by Airbnb, with search, filter, and reservation features. | React, TypeScript, Tailwind, Node.js | [🔗 View Demo](https://aribnb-cse-phong.vercel.app) |
